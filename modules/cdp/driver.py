...
def _cleanup_session_dead(driver: object, exc_or_text: object | None = None) -> str | None:
...
class GivexDriver:
    ...
    def _clear_browser_state(self) -> None:
        ...
        """
        reason = _cleanup_session_dead(self._driver)
        ...
        try:
            ...
            reason = _cleanup_session_dead(self._driver, exc)
            if reason is not None:
                _log_cleanup_session_dead_once(reason)
                return
